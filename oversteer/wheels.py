...
class Wheels:
    ...
    def device_file(self, device_id, filename):
        path = os.path.join(self.devices[device_id]['path'], filename)
    ...
    def get_autocenter(self, device_id):
        path = self.device_file(device_id, "autocenter")
        if not path:
            return 0
        with open(path, "r") as file:
            data = file.read()
    ...
    def get_ff_gain(self, device_id):
        path = self.device_file(device_id, "gain")
        if not path:
            return 100
        with open(path, "r") as file:
            data = file.read()
    ...
    def get_spring_level(self, device_id):
        path = self.device_file(device_id, "spring_level")
        if not path:
            return None
        with open(path, "r") as file:
            data = file.read()
    ...
    def get_damper_level(self, device_id):
        path = self.device_file(device_id, "damper_level")
        if not path:
            return None
        with open(path, "r") as file:
            data = file.read()
    ...
    def get_friction_level(self, device_id):
        path = self.device_file(device_id, "friction_level")
        if not path:
            return None
        with open(path, "r") as file:
            data = file.read()
    ...
    def get_ffb_leds(self, device_id):
        path = self.device_file(device_id, "ffb_leds")
        if not path:
            return None
        with open(path, "r") as file:
            data = file.read()
    ...
    def get_peak_ffb_level(self, device_id):
        path = self.device_file(device_id, "peak_ffb_level")
        if not path:
            return None
        with open(path, "r") as file:
            data = file.read()
