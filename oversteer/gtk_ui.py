...
class GtkUi:
    ...
    def _set_markers(self):
        ...
        self.autocenter.add_mark(20, Gtk.PositionType.TOP, '20')
        self.autocenter.add_mark(40, Gtk.PositionType.TOP, '40')
        self.autocenter.add_mark(60, Gtk.PositionType.TOP, '60')
        self.autocenter.add_mark(80, Gtk.PositionType.TOP, '80')
        self.autocenter.add_mark(100, Gtk.PositionType.TOP, '100')
        ...
        self.ff_spring_level.add_mark(20, Gtk.PositionType.TOP, '20')
        self.ff_spring_level.add_mark(40, Gtk.PositionType.TOP, '40')
        self.ff_spring_level.add_mark(60, Gtk.PositionType.TOP, '60')
        self.ff_spring_level.add_mark(80, Gtk.PositionType.TOP, '80')
        self.ff_spring_level.add_mark(100, Gtk.PositionType.TOP, '100')
        self.ff_damper_level.add_mark(20, Gtk.PositionType.TOP, '20')
        self.ff_damper_level.add_mark(40, Gtk.PositionType.TOP, '40')
        self.ff_damper_level.add_mark(60, Gtk.PositionType.TOP, '60')
        self.ff_damper_level.add_mark(80, Gtk.PositionType.TOP, '80')
        self.ff_damper_level.add_mark(100, Gtk.PositionType.TOP, '100')
        self.ff_friction_level.add_mark(20, Gtk.PositionType.TOP, '20')
        self.ff_friction_level.add_mark(40, Gtk.PositionType.TOP, '40')
        self.ff_friction_level.add_mark(60, Gtk.PositionType.TOP, '60')
        self.ff_friction_level.add_mark(80, Gtk.PositionType.TOP, '80')
        self.ff_friction_level.add_mark(100, Gtk.PositionType.TOP, '100')
